...
test('render ActionDetail', () => {
    const productMock: IProductDetail = {
        ...
        nfc: "",
        options: {
            colors: [{ code: 1, name: "Rojo" }], storages: [{ code: 1, name: "100GB" }]
        },
        os: "",
        price: "220",
    ...
    const { container } = render(<ActionDetail product={productMock} handleClickAddProduct={mockHandleClickAddProduct} />);
