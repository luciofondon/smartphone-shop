            ...
            <form onSubmit={handleSubmit}>
                <div className='form-select'>
                    <FormControl fullWidth>
                        ...
                        >
                            {
                                product.options.storages.map(storage => <MenuItem value={storage.code}>{storage.name}</MenuItem>
                                )
                            }
                        </Select>
                    </FormControl>
                ...
                <div className='form-select'>
                    <FormControl fullWidth>
                        ...
                        >
                            {
                                product.options.colors.map(color => <MenuItem value={color.code}>{color.name}</MenuItem>
                                )
                            }
                        </Select>
                    </FormControl>
